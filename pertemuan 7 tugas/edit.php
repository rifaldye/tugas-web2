...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    $sql = "SELECT * FROM pertemuan7tugas where id=$id";
    ...
    <?php while ($row = mysqli_fetch_array($query)) { ?>
      <table>
        ...
        <tr>
          <td>sekolah asal</td>
          <td>:</td>
          <td> <input type="text" name="sekolah" value="<?= $row['sekolah']  ?>"> </td>
        </tr>
      </table>
    <?php } ?>
    ...
    if (isset($_POST['submit'])) {
      ...
      $sql = "UPDATE " . "pertemuan7tugas SET nama='$nama',alamat='$alamat',kelamin='$kelamin',agama='$agama',sekolah='$sekolah' WHERE id=$id";
